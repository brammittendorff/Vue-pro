    ...
    >
      <div>
        <!-- <p v-if="useof<=0||useof==2" style="margin-top:20px" class="title_style">
          <span class="el-icon-setting" style="margin-right:10px;font-size:16px"></span>媒介端
        </p> -->
        <template
  ...
  methods: {
    ...
    getuseof() {
      ...
      if (!(objuserInfo.is_vip_master||objuserInfo.is_leader==1||objuserInfo.group_id ==2)) {
        this.$router.push({ path: "/set/user_con" });
      }
    }
  },
  mounted() {
