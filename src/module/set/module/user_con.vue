    ...
    <div class="usermanagent">
      ...
      <div class="g-container">
        ...
        <div class="th-gray-table">
            <el-table
                ...
                <template slot-scope="scope">
                    <p><a>修改信息</a> <a @click="frozen">冻结</a></p>
                    <p><a>绑定微信</a> <a>删除</a></p>
                </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog
            ...
            <div slot="title"></div>
            <div>
              <p style="font-size:24px;"> <i class="el-icon-warning" style="font-size:24px;color:red"></i> <span style="font-size:20px;">确定冻结改账户？</span> </p>
            </div>
            <span slot="footer" class="dialog-footer">
