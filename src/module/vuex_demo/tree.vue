    ...
    <div class="all-div" v-if="model.name">
      <div class="itemRow" :style="{ marginLeft:model.level*20+'px'}">
        ...
        <div class="hover-div" @mouseover="flag=true" @mouseout="flag=false">
          ...
          <span v-show="flag==true" @click="add"><i class="el-icon-circle-plus-outline"></i></span>
          <span v-show="flag==true" @click="remove(model)"><i class="el-icon-remove-outline"></i></span>
          <span v-show="flag==true" @click="edit"><i class="el-icon-edit"></i></span>
