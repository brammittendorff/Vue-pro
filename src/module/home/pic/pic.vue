    ...
    >
      ...
      <el-form>
        ...
        <el-form-item>
          <p>上传我的照片（必传）</p>
          <el-upload
            action="http://img-crm.s.youfenba.com/"
            ref="gzhimg"
...
console.log(greeter(user),'greeter(user)')
  ...
  methods: {
      ...
      this.fileList = [
        {
          ...
          url: `http://img-crm.s.youfenba.com/${this.imgToken.key}`
          // http://img-crm.s.youfenba.com/gzh/XK6Emw2jFJ.jpg
        }
      ];
      this.postaxios();
    },
    ...
    beforeUpload(file) {
      this.$axios
        .get("http://crm-q1.youfenba.com/medium_mp/token?dir=gzh/")
        // accessid: "Zssxcg0nUUpge8q2"
        // dir: "gzh/"
        // expire: 1570504743
        // host: "http://img-crm.s.youfenba.com"
        // policy: "eyJleHBpcmF0aW9uIjoiMjAyMC0wMS0wMVQxMjowMDowMC4wMDBaIiwiY29uZGl0aW9ucyI6W1siY29udGVudC1sZW5ndGgtcmFuZ2UiLDAsMTA0ODU3NjAwMF0sWyJzdGFydHMtd2l0aCIsIiRrZXkiLCJnemhcLyJdXX0="
        // signature: "/NYbLEmWxDmNaZYnUQdCbhN2Ggk="
        .then(res => {
          if (res.data) {
